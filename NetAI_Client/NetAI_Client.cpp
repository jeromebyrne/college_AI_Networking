                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_NETAI_CLIENT, GLwindow::GetInstance()->szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_NETAI_CLIENT));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_NETAI_CLIENT));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	//wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.hbrBackground	= 0;
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_NETAI_CLIENT);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   GLwindow::GetInstance()->Initialise(hInstance, nCmdShow);
   m_game = new Game();
   m_game->Initialise();
   m_hWnd = GLwindow::GetInstance()->GetHwndRef();
   return TRUE;
}
